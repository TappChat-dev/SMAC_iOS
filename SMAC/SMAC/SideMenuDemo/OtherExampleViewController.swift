...
class OtherExampleViewController: UIViewController {
    ...
    @IBAction func switchToProgrammaticallyExample(_ sender: Any) {
        let contentViewController = UIStoryboard(name: "MainStory", bundle: nil).instantiateViewController(withIdentifier: "ContentNavigation")
        let menuViewController = UIStoryboard(name: "MainStory", bundle: nil).instantiateViewController(withIdentifier: "MenuNavigation")
    ...
    @IBAction func switchToIBExample(_ sender: Any) {
        let sideMenuController = UIStoryboard(name: "MainStory", bundle: nil).instantiateViewController(withIdentifier: "SideMenu")
        UIApplication.shared.keyWindow?.rootViewController = sideMenuController
    }
    ...
    @IBAction func switchToHybridExample(_ sender: Any) {
        let contentViewController = UIStoryboard(name: "MainStory", bundle: nil).instantiateViewController(withIdentifier: "ContentNavigation")
        let menuViewController = UIStoryboard(name: "MainStory", bundle: nil).instantiateViewController(withIdentifier: "MenuNavigation")
        guard let sideMenuController = UIStoryboard(name: "MainStory", bundle: nil)
